###########################################################################
## Makefile generated for component 'MPU6050_example'. 
## 
## Makefile     : MPU6050_example.mk
## Generated on : Sun Feb 25 18:55:13 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MPU6050_example.elf
...
PRODUCT_NAME              = MPU6050_example
MAKEFILE                  = MPU6050_example.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/data_reconstruction/¿¬±¸½Ç/GAROONG/[2401]stair-exoskeleton/IMU
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/admin/DOCUME~1/MATLAB/R2023a/ARDUIN~1/ARDUIN~1/FASTER~2
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MPU6050_example.elf
...
DEFINES_STANDARD = -DMODEL=MPU6050_example -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduinoI2C.o io_wrappers.o xcp_ext_mode.o MPU6050_example.o MPU6050_example_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/MPU6050_example_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/MPU6050_example_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/MPU6050_example_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MPU6050_example.o : $(START_DIR)/MPU6050_example_ert_rtw/MPU6050_example.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MPU6050_example_data.o : $(START_DIR)/MPU6050_example_ert_rtw/MPU6050_example_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/MPU6050_example_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
