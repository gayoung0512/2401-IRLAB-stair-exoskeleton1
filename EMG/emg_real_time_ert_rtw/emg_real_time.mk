###########################################################################
## Makefile generated for component 'emg_real_time'. 
## 
## Makefile     : emg_real_time.mk
## Generated on : Tue Aug 13 22:48:24 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/emg_real_time.elf
...
PRODUCT_NAME              = emg_real_time
MAKEFILE                  = emg_real_time.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/data_reconstruction/¿¬±¸½Ç/GAROONG/[2401]stair-exoskeleton/EMG
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/emg_real_time.elf
...
DEFINES_STANDARD = -DMODEL=emg_real_time -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o emg_real_time.o emg_real_time_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/emg_real_time_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/emg_real_time_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/emg_real_time_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
emg_real_time.o : $(START_DIR)/emg_real_time_ert_rtw/emg_real_time.c
	$(CC) $(CFLAGS) -o "$@" "$<"


emg_real_time_data.o : $(START_DIR)/emg_real_time_ert_rtw/emg_real_time_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/emg_real_time_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
